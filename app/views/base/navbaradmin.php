<nav class="navbar navbar-dark bg-dark navbar-expand-md">
    <a href="/webperpustakaan" class="navbar-brand">Webperpustakaan</a>
    ...
    <div class="navbar-collapse collapse" id="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="/webperpustakaan/login" class="nav-link">Login</a></li>
            <li class="nav-item"><a href="/webperpustakaan/login/logout" class="nav-link">Logout</a></li>
        </ul>
    </div>
</nav>